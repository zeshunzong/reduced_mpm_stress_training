...
class Exporter(object):
    ...
    def export(self, ):
        ...
        # print(net.train_every_n_points)
        # input()
        ...
        data_list = DataList(net.data_format['data_path'], 1.0, train_every_k_timestep=1)
        
        dataset = SimulationDataset(net.data_format['data_path'], data_list.data_list, train_every_n_points=net.train_every_n_points)
        ...
        print('encoder torchscript path: ', enc_jit_path)
        ...
        assert(criterion(grad_gt_auto, grad_gt)<1e-6)
        assert(criterion(grad, grad_gt)<1e-6)
        assert(criterion(y, y_gt)<1e-6)
